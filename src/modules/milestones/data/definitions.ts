...
export const MILESTONES: MilestoneDef[] = [
  // ── 0–2 Months (Fourth Trimester) ──
  {
    ...
    expectedEndMonth: 3,
    targetWeek: 6,
    observationPrompt: 'When you lean in close and smile, does {babyName} smile back — not a reflex, but a real, eyes-crinkling response?',
  ...
  },
  {
    ...
    expectedEndMonth: 3,
    targetWeek: 4,
    observationPrompt: 'During tummy time, does {babyName} lift their head off the mat for a few seconds and look around?',
  ...
  },
  {
    ...
    expectedEndMonth: 3,
    targetWeek: 8,
    observationPrompt: 'If you slowly move a rattle about 10 inches from {babyName}\'s face, do their eyes follow it side to side?',
  ...
  // ── 2–4 Months ──
  {
    ...
    expectedEndMonth: 4,
    targetWeek: 10,
    observationPrompt: 'Is {babyName} making little vowel sounds — \'ahh\', \'ooo\' — especially when you talk to them?',
  ...
  },
  {
    ...
    expectedEndMonth: 4,
    targetWeek: 11,
    observationPrompt: 'Have you noticed {babyName} discovering their hands and bringing them to their mouth to explore?',
  ...
  // ── 4–6 Months ──
  {
    ...
    expectedEndMonth: 6,
    targetWeek: 18,
    observationPrompt: 'During floor time, has {babyName} rolled from tummy to back (or back to tummy) — even once?',
  ...
  },
  {
    ...
    expectedEndMonth: 6,
    targetWeek: 16,
    observationPrompt: 'Has {babyName} let out a real belly laugh — that magical sound that makes everything worth it?',
  ...
  },
  {
    ...
    expectedEndMonth: 6,
    targetWeek: 20,
    observationPrompt: 'If you dangle a colorful toy within reach, does {babyName} intentionally reach out and try to grab it?',
  ...
  // ── 6–9 Months ──
  {
    ...
    expectedEndMonth: 9,
    targetWeek: 28,
    observationPrompt: 'Can {babyName} sit upright on the floor for a stretch without toppling over — hands free to play?',
  ...
  },
  {
    ...
    expectedEndMonth: 9,
    targetWeek: 30,
    observationPrompt: 'Is {babyName} stringing sounds together — \'ba-ba\', \'ma-ma\', \'da-da\' — practicing speech?',
  ...
  },
  {
    ...
    expectedEndMonth: 9,
    targetWeek: 30,
    observationPrompt: 'Does {babyName} get shy or cautious around unfamiliar faces? That\'s actually a great sign!',
  ...
  // ── 9–12 Months ──
  {
    ...
    expectedEndMonth: 11,
    targetWeek: 36,
    observationPrompt: 'Is {babyName} moving across the floor — army crawl, classic crawl, scoot — any method counts!',
  ...
  },
  {
    ...
    expectedEndMonth: 14,
    targetWeek: 46,
    observationPrompt: 'Has {babyName} said a word with clear intention — \'mama\' for you, \'dada\' for dad, \'ba\' for ball?',
  ...
  },
  {
    ...
    expectedEndMonth: 12,
    targetWeek: 42,
    observationPrompt: 'Does {babyName} grab furniture or your hands and pull themselves up to standing?',
  ...
  },
  {
    ...
    expectedEndMonth: 12,
    targetWeek: 42,
    observationPrompt: 'Can {babyName} pick up a small puff or cereal piece between their thumb and forefinger?',
  ...
  },
  {
    ...
    expectedEndMonth: 13,
    targetWeek: 44,
    observationPrompt: 'When you wave bye-bye, does {babyName} wave back — showing they understand social gestures?',
